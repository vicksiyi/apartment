  ...
  <div class="submit">
    ...
    >
      ...
      <el-input placeholder="请输入租客联系电话" v-model="ruleForm.mobile"></el-input>
            ...
            <el-form-item label="租金" prop="mon" required>
        <el-input placeholder="请输入租金" v-model="ruleForm.mon"></el-input>
      </el-form-item>
       <el-form-item label="距离到期时间还有" prop="datenum" required>
        <el-input v-model="ruleForm.datenum"></el-input>
      </el-form-item>
      <el-form-item label="状态" prop="status" required>
         <el-radio v-model="radio" label="1">未完成交付</el-radio>
  <el-radio v-model="radio" label="2">已完成交付</el-radio>
      </el-form-item>
      <el-form-item>
